...
* residuals are distributed normally- If the data are exactly normal, we expect the points to lie on a straight line.
...
To sum up this results we can determine which there is a linear correlation between score and Healthy life expectancy.
...
determine which there is a linear corrolotaion between score and Healthy life expectancy.
